...
RcppExport SEXP _MeLSI_melsi_permanova_f(SEXP XtSEXP, SEXP groupSEXP, SEXP kSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(melsi_permanova_f(Xt, group, k));
...
RcppExport void R_init_MeLSI(DllInfo *dll) {
